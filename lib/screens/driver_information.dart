...
import 'package:vdrivpartner/compaign.dart';
import 'package:vdrivpartner/screens/assigned.dart';
import 'package:vdrivpartner/screens/terms_screen.dart'; // Import the package
...
class DriverInformationScreen extends StatefulWidget {
  ...
  const DriverInformationScreen({Key? key, required this.selectedLanguage, required this.phoneNumber, required this.driverType}) : super(key: key);
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if(widget.driverType == "Temporary Driver")
                              {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                              ...
                              else if(widget.driverType == "Permanent Driver")
                              {
