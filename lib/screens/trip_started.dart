...
import 'package:vdrivpartner/screens/login.dart';
import 'package:vdrivpartner/screens/trip_details.dart';

class TripStartedScreen extends StatelessWidget {
  final String selectedLanguage;
  const TripStartedScreen({Key? key, required this.selectedLanguage}) : super(key: key);
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TripDetailsScreen(selectedLanguage: selectedLanguage),
                      ),
                    );
                  },
