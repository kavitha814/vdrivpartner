...
import 'package:vdrivpartner/screens/details.dart';
...
class _CampaignDashboardState extends State<CampaignDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      extendBody: true, // This extends the body behind the bottom nav bar
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            WorkCard(
              title: 'RTO Services',
              subtitle: 'Registration and Documentaion',
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: const <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              icon: SizedBox(width: 60), // Empty space for center button
              label: '',
            ),
            BottomNavigationBarItem(
      ...
      floatingActionButton: Container(
        ...
        height: 70,
        decoration: BoxDecoration(
          color: Colors.black, // Pink color like in your reference image
        ...
        child: Material(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(35),
            onTap: () {
              // Handle job button tap - navigate to current job or job list
              print('Job button pressed');
              // You can add navigation to job screen here
      ...
      // Add this line to center the floating action button
...
class _WorkCardState extends State<WorkCard> {
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Text('Book Slot', style: TextStyle(fontSize: 12)),
  ...
  Widget _buildSlotItem(SlotItem item, int index) {
    return Column(
      children: [
        CheckboxListTile(
          value: _selectedSlotIndex == index,
          onChanged: (bool? value) {
            setState(() {
              if (value == true) {
