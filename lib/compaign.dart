...
class _CampaignDashboardState extends State<CampaignDashboard> {
  ...
  String selectedLanguage = "English"; // State variable for the switch
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Transform.scale(
                  scale: 1.2, // Slightly larger size for better touch target
                  child: Switch(
                    value: _isSwitchOn,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    // Use a single container for all slots
                    Container(
